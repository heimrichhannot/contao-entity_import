...
$GLOBALS['TL_LANG']['tl_entity_import_config']['dbFieldMappingOptions']['foreignKey']	= 'Fremdschlüssel (Quelle)';
$GLOBALS['TL_LANG']['tl_entity_import_config']['dbFieldMappingOptions']['value']	= 'Wert';
$GLOBALS['TL_LANG']['tl_entity_import_config']['source']			= array('Quellfeld', 'Wählen Sie hier nur dann ein Feld aus, wenn Sie als Typ \'Quellfeld\' oder \'Fremdschlüssel\' gewählt haben.');
$GLOBALS['TL_LANG']['tl_entity_import_config']['value']				= array('Wert / Fremdschlüssel', 'Geben Sie hier nur dann einen Wert oder Fremdschlüssel-Feld ein, wenn Sie als Typ \'Wert\' oder \'Fremdschlüssel\' gewählt haben.');
