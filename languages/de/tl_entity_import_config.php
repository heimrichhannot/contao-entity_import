...
$arrLang['description']                          = ['Beschreibung', 'Geben Sie hier eine Beschreibung für diese Konfiguration ein. Sie erscheint in der Listenansicht.'];
$arrLang['dbSourceTable']                        = ['Quelltabelle', 'Wählen Sie hier die Tabelle aus, die als Quelle des Imports dienen soll.'];
$arrLang['dbTargetTable']                        = ['Zieltabelle', 'Wählen Sie hier die Tabelle aus, die als Ziel des Imports dienen soll.'];
$arrLang['importerClass']                        =
    ['Importerklasse', 'Wählen Sie hier die PHP-Klasse, die als Importer fungieren soll. Die Klasse muss eine Subklasse von "\\HeimrichHannot\\EntityImport\\Importer" sein.'];
$arrLang['purgeBeforeImport']                    =
    ['Datensätze in der Zieltabelle vor dem Import löschen', 'Wählen Sie diese Option, wenn in der Zieltabelle vor jedem Import Datensätze gelöscht werden sollen.'];
$arrLang['whereClausePurge']                     =
    ['WHERE-Bedingungen für das Löschen', 'Geben Sie hier SQL-Bedingungen in der Form "pid=27 AND id=1" ein, die für das Löschen von Datensätzen vor jedem Import gelten sollen.'];
$arrLang['dbFieldMapping']                       = ['Felderabbildung', 'Wählen Sie hier aus, welche Felder der Quelltabelle auf welche der Zieltabelle abgebildet werden sollen.'];
...
$arrLang['dbFieldMapping']['source']             = ['Quellfeld', 'Wählen Sie hier nur dann ein Feld aus, wenn Sie als Typ \'Quellfeld\' oder \'Fremdschlüssel\' gewählt haben.'];
...
$arrLang['whereClause']                          = ['WHERE-Bedingungen', 'Geben Sie hier Bedingungen für die WHERE-Klausel in der Form "pid=27 AND id=1" ein.'];
$arrLang['sourceDir']                            = ['Quellverzeichnis', 'Wählen Sie hier das Quellverzeichnis für Dateiimporte aus.'];
$arrLang['targetDir']                            = ['Zielverzeichnis', 'Wählen Sie hier das Zielverzeichnis für Dateiimporte aus.'];
$arrLang['catContao']                            = ['Nachrichten-Kategorien', 'Wählen Sie hier die Kategorien aus, die den importierten Nachrichten zugewiesen werden sollen.'];
$arrLang['newsArchive']                          = ['Nachrichtenarchiv', 'Wählen Sie hier das Nachrichtenarchiv aus, in das die Nachrichten importiert werden sollen.'];
$arrLang['sourceFile']                           = ['Quell-Datei', 'Wählen Sie hier die zu Quell-Datei für den Import aus.'];
...
$arrLang['fileFieldMapping']                     = ['Felderabbildung', 'Wählen Sie hier aus, welche Felder der Quelldatei auf welche der Zieltabelle abgebildet werden sollen.'];
$arrLang['fileFieldMapping']['type']             =
    ['Typ', 'Wählen Sie \'Spalte\', um den Wert einer Spalte in der Quell in das entsprechende Feld der Zieltabelle zu schreiben. Für einfache Werte nutzen Sie \'Wert\'.'];
$arrLang['fileFieldMapping']['type']['source']   = 'Spalte';
$arrLang['fileFieldMapping']['type']['value']    = 'Wert';
$arrLang['fileFieldMapping']['source']           =
    ['Quellspalte', 'Geben Sie hier nur die Position der Spalte ein, wenn Sie als Typ \'Quellspalte\' gewählt haben. Für die erste Spalte in der Datei geben Sie bspw. 1 ein.'];
$arrLang['fileFieldMapping']['value']            = ['Wert', 'Geben Sie hier nur dann einen Wert ein, wenn Sie als Typ \'Wert\' gewählt haben.'];
