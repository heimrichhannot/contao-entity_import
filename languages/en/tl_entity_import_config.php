 ...
 * Buttons
 */
$GLOBALS['TL_LANG']['tl_entity_import_config']['new']        		= array('New config', 'Create a new config');
$GLOBALS['TL_LANG']['tl_entity_import_config']['show']       		= array('Config details', 'Show config ID %s');
$GLOBALS['TL_LANG']['tl_entity_import_config']['edit']       		= array('Edit config', 'Edit config ID %s ');
$GLOBALS['TL_LANG']['tl_entity_import_config']['copy']       		= array('Copy config', 'Copy config ID %s');
$GLOBALS['TL_LANG']['tl_entity_import_config']['delete']     		= array('Delete config', 'Delete config ID %s');
